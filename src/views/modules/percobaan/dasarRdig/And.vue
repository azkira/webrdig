  ...
  <div class="my-2">
    ...
    <v-row>
      <v-col class="grid">
        <v-row>
          <v-col>
            <v-btn @click="switch1('0'); ledOff1()" color="primary" elevation="2" icon>0</v-btn>
            <v-btn @click="switch1('1'); ledOn1()" color="primary" elevation="2" icon>1</v-btn>
            <v-col>
        ...
        <v-row>
          <v-col>
            <v-btn @click="switch2('0'); ledOff2()" color="primary" elevation="2" icon>0</v-btn>
            <v-btn @click="switch2('1'); ledOn2()" color="primary" elevation="2" icon>1</v-btn>
            <v-col>
